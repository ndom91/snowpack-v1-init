...
const installDependencies = appDirectory => {
  return new Promise(resolve => {
    ...
    shell.exec(
      `cd ${appDirectory} && npm install -q --save preact preact-compat preact-emotion preact-router emotion > /dev/null`,
      () => {
